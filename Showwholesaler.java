...
public class Showwholesaler extends JFrame implements ActionListener
{
	...
	public Showwholesaler()
	{
		...
		plz = new JLabel("Enter Wholesaler Name to see Details:");
		...
		//Textfield
	  	...
	  	txt.setBounds(450,170,150,25);
	  	cont.add(txt);
		
		//TextArea
		
		ta = new JTextArea(100,50);
	  	ta.setBounds(50,250,900,200);
			...
			try
				{
					...
					q = "select wid,wname,wadd,wph,wdlno from wholesaler where wname=?";
					...
					//{
                                       ...
                                       ta.setText("");
					ta.append("  wholesaler id                  Wholesaler Name                 Wholesaler Add                  ph.No.            Drug licence No.\n");  
		            ta.append("---------------------------------------------------------------------------------------------------------------------------------\n");    					
				   	while(rs.next())
						{
